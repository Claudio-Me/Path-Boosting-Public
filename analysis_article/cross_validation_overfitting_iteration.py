...
def cross_validation(number_of_simulations=200, k_folds=5, synthetic_dataset_scenario=1, patience=3,
    ...
    plot_test_error_vs_iterations(list_of_test_errors, save_fig=save_fig)


def cross_validation_synthetic_dataset(number_of_simulations=200, k_folds=5, synthetic_dataset_scenario=1,
                                       noise_variance=0.2,
                                       maximum_number_of_steps=None, save_fig=False, use_wrapper_boosting=None):
    folder_relative_path = "analysis_article"
...
def cross_validation_normal_dataset(number_of_simulations=200, synthetic_dataset_scenario=1, noise_variance=0.2,
...
cross_validation_synthetic_dataset(number_of_simulations=200, k_folds=5, synthetic_dataset_scenario=1,
                                   noise_variance=0.2,
                                   maximum_number_of_steps=None, save_fig=False)
