...
def true_positive_ratio(number_of_simulations=200, synthetic_dataset_scenario=1, noise_variance=0.2,
    ...
    print(np.average(n_selected_paths_per_iterations, axis=0))
...
true_positive_ratio(number_of_simulations=200, synthetic_dataset_scenario=3, noise_variance=0.2,
                        maximum_number_of_steps=None, save_fig=True)